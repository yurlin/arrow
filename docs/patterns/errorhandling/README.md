...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@627d9ea1
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.core.TryMonadErrorInstanceImplicits$instance$1@7f45d7d
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@740bdef3
```
